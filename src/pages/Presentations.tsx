...
function Presentations() {
  ...
  return (
    ...
    >
      <button
        onClick={() => navigate("/")}
        className="absolute top-2 left-2 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full p-2 text-white cursor-pointer z-10"
      >
        <ArrowBigLeft />
      </button>
      ...
      <PresentationSelect
        ...
        setIsPreviousVisible={setIsPreviousVisible}
        setIsNextVisible={setIsNextVisible}
      />
